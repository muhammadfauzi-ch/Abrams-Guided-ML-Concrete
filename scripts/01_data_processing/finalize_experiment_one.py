...
INPUT_PATH = ROOT / "data" / "processed" / "exp1_harmonized.csv"
OUTPUT_CSV = ROOT / "data" / "processed" / "finaldataexp1.csv"
OUTPUT_XLSX = ROOT / "data" / "processed" / "finaldataexp1.xlsx"
...
def create_base_dataset(data):
    ...
    output["Study_ID"] = "EXP1_FINAL"
    output["DOI"] = np.nan
    output["Domain_Tag"] = "Experimental_Exp1"
    ...
    binder_content = output["Cement_kgm3"] + scm_content
...
def main():
    ...
    final_dataset = apply_schema(final_dataset)
